...
# with command line options: miniAOD-step --filein file:/eos/cms/store/relval/CMSSW_15_0_0/RelValTTbar_14TeV/GEN-SIM-RECO/141X_mcRun4_realistic_v3_STD_RecoOnly_Run4D110_PU-v1/2580000/069414cc-81de-4063-9760-9ec3ef83bc11.root --fileout file:TTbar1_TOFPID_MTDtracks_MiniAOD.root --mc --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions 141X_mcRun4_realistic_v3 --step PAT --geometry ExtendedRun4D110 --era Phase2C17I13M9 --runUnscheduled --no_exec -n 10
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/relval/CMSSW_15_0_0/RelValTTbar_14TeV/GEN-SIM-RECO/141X_mcRun4_realistic_v3_STD_RecoOnly_Run4D110_PU-v1/2580000/069414cc-81de-4063-9760-9ec3ef83bc11.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('miniAOD-step nevts:10'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TTbar1_TOFPID_MTDtracks_MiniAOD.root'),
